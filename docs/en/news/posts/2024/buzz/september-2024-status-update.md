...
- We transitioned Toga's GTK backend to use [PyGObject's native `asyncio` support](https://github.com/beeware/toga/pull/2550). This allowed us to deprecate [<nospell>Gbulb</nospell>](https://github.com/beeware/gbulb), the GTK `asyncio` plugin that we've been maintaining for several years.
